...
#define _CAIRO_GSTATE_CLASSNAME CairoGState
#define _CAIRO_SURFACE_CLASSNAME WasmCairoIOSurface
#else
                    ...
                    title:(NSString *)aTitle
{
    ...
    if (printInfo != nil) {
        ...
        [NSException raise:NSInternalInconsistencyException
                    format:@"current print operation printInfo is nil in %@", NSStringFromSelector(_cmd)];
        return;
    }

    contextType = [context_info objectForKey:NSGraphicsContextRepresentationFormatAttributeName];
